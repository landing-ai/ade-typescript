...
* **mcp:** link to the published local code execution docs ([c4782f2](https://github.com/landing-ai/ade-typescript/commit/c4782f22a284ee6f4bf4cff9b41f039301229f58))
...
* update SDK settings ([60f792d](https://github.com/landing-ai/ade-typescript/commit/60f792d860001e2e9f44526f4da48cd9a7714130))
...
* **api:** custom prompts transformations ([d1df5de](https://github.com/landing-ai/ade-typescript/commit/d1df5dee997dcec15dc2493acc266fa5cf50bf55))
...
* update SDK settings ([112cbc4](https://github.com/landing-ai/ade-typescript/commit/112cbc44435895e04449fd829871035d6eb1faab))

## 2.3.1 (2026-03-11)

Full Changelog: [v2.3.0...v2.3.1](https://github.com/landing-ai/ade-typescript/compare/v2.3.0...v2.3.1)

### Chores

* update SDK settings ([689e3d5](https://github.com/landing-ai/ade-typescript/commit/689e3d5491d7d70554d2c8430edc9fa04c2cf3d1))

## 2.3.0 (2026-03-10)

Full Changelog: [v2.2.0...v2.3.0](https://github.com/landing-ai/ade-typescript/compare/v2.2.0...v2.3.0)

### Features

* **mcp:** add an option to disable code tool ([6bf5d29](https://github.com/landing-ai/ade-typescript/commit/6bf5d295c4d9c0eec47cbda9ee3b4dd283b35a90))


### Bug Fixes

* **client:** preserve URL params already embedded in path ([54fa781](https://github.com/landing-ai/ade-typescript/commit/54fa781697fd52608587c72b4a35d9e6713e1f90))
* **docs/contributing:** correct pnpm link command ([24fe113](https://github.com/landing-ai/ade-typescript/commit/24fe113a4f623f1fdfe2ca4709dcab8cdc92a4b5))
...
* **mcp:** update prompt ([5f373a1](https://github.com/landing-ai/ade-typescript/commit/5f373a103aff24366b49fd6c121a98501e945320))


### Chores

* **ci:** skip uploading artifacts on stainless-internal branches ([b4e7301](https://github.com/landing-ai/ade-typescript/commit/b4e73016fbcc9ed890422a908a99ca5c3d37a0e4))
...
* **internal:** codegen related update ([77640e2](https://github.com/landing-ai/ade-typescript/commit/77640e2f45cc1be1f4f83de89e98151a7a721868))
* **internal:** codegen related update ([6a56bb0](https://github.com/landing-ai/ade-typescript/commit/6a56bb0fc093c7cd28f0c3283d45b622bdb59425))
* **internal:** fix MCP Dockerfiles so they can be built without buildkit ([bc96cb3](https://github.com/landing-ai/ade-typescript/commit/bc96cb3229da871d2d12d6f657fb577185c98bb8))
* **internal:** fix MCP Dockerfiles so they can be built without buildkit ([2cdc8ec](https://github.com/landing-ai/ade-typescript/commit/2cdc8eca2dad22e7a1c530311660770a6dffe9ad))
* **internal:** make MCP code execution location configurable via a flag ([6536209](https://github.com/landing-ai/ade-typescript/commit/6536209b00efc115203d1d0bfd163e6d1fcc1a0b))
* **internal:** move stringifyQuery implementation to internal function ([73cfd11](https://github.com/landing-ai/ade-typescript/commit/73cfd1112e21736700a17e44daa5de000d361219))
...
* **internal:** update dependencies to address dependabot vulnerabilities ([c73ddc1](https://github.com/landing-ai/ade-typescript/commit/c73ddc173dee80b01f0c609761a2b1887ea6618b))
* **internal:** upgrade @modelcontextprotocol/sdk and hono ([4ef10d6](https://github.com/landing-ai/ade-typescript/commit/4ef10d61261e58274c8ea7fb21409b89e1f11149))
* **internal:** use x-stainless-mcp-client-envs header for MCP remote code tool calls ([6f31ae9](https://github.com/landing-ai/ade-typescript/commit/6f31ae9d39de02e5be5ad5a5fdaf3c2453a8afcf))
* **mcp-server:** improve instructions ([e4a9a2e](https://github.com/landing-ai/ade-typescript/commit/e4a9a2ee532e47c8582dcf933cf3c0ea1ed01464))
* **mcp-server:** return access instructions for 404 without API key ([442f27b](https://github.com/landing-ai/ade-typescript/commit/442f27b1853992e2d5af51b75a7f9fbf96df418d))
...
* update placeholder string ([a33f49c](https://github.com/landing-ai/ade-typescript/commit/a33f49c9cdb07d4dfb63d8e514910f8c9bde0d82))
