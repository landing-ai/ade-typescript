...
import {
  ...
  ToolActivityRecognitionParams,
  ToolActivityRecognitionResponse,
  ToolAgenticDocumentAnalysisParams,
  ToolAgenticDocumentAnalysisResponse,
  ToolAgenticObjectDetectionParams,
  ToolBarcodeReaderParams,
  ToolBarcodeReaderResponse,
  ToolClassificationParams,
  ToolClassificationResponse,
  ToolCountgdParams,
  ToolCustomObjectDetectionParams,
  ToolDepthAnythingV2Params,
  ToolDepthAnythingV2Response,
  ToolDepthProParams,
  ToolDepthProResponse,
  ToolDoclingParams,
  ToolDoclingResponse,
  ToolDocumentAnalysisParams,
  ToolDocumentAnalysisResponse,
  ToolEmbeddingsParams,
  ToolEmbeddingsResponse,
  ToolFlorence2Params,
  ToolFlorence2QaParams,
  ToolFlorence2QaResponse,
  ToolFlorence2Response,
  ToolFlorence2Sam2Params,
  ToolFlorence2Sam2Response,
  ToolFlux1Params,
  ToolFlux1Response,
  ToolGleeParams,
  ToolImageToTextParams,
  ToolImageToTextResponse,
  ToolInternlmXcomposer2Params,
  ToolInternlmXcomposer2Response,
  ToolLicensePlateParams,
  ToolLicensePlateResponse,
  ToolLocaParams,
  ToolLocaResponse,
  ToolMarkdownSchemaSuggestionParams,
  ToolMarkdownSchemaSuggestionResponse,
  ToolNsfwClassificationParams,
  ToolNsfwClassificationResponse,
  ToolOwlv2Params,
  ToolPaddleOcrParams,
  ToolPaddleOcrResponse,
  ToolPoseDetectorParams,
  ToolPoseDetectorResponse,
  ToolQrReaderParams,
  ToolQrReaderResponse,
  ToolSam2Params,
  ToolTextToInstanceSegmentationParams,
  ToolTextToObjectDetectionParams,
  ToolVideoTemporalLocalizationParams,
  ToolVideoTemporalLocalizationResponse,
  ToolVisualPromptsToObjectDetectionParams,
  ToolWsiEmbeddingParams,
  ToolWsiEmbeddingResponse,
  Tools,
...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['ADE_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['ADE_LOG'] or 'warn' if it isn't set.
   */
...
export class Ade {
  ...
  constructor({
    ...
    this.timeout = options.timeout ?? Ade.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('ADE_LOG'), "process.env['ADE_LOG']", this) ??
      defaultLogLevel;
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== 'https://api.va.landing.ai';
  }
  ...
  static AdeError = Errors.AdeError;
