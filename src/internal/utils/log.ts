...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: LandingAIADE): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: LandingAIADE): Logger {
