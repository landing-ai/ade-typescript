...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    "response": "{ extraction: object; extraction_metadata: object; metadata: { credit_usage: number; duration_ms: number; filename: string; job_id: string; org_id: string; version: string; fallback_model_version?: string; schema_violation_error?: string; warnings?: { code: 'nonconformant_schema' | 'nonconformant_output'; msg: string; }[]; }; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.va.landing.ai/v1/ade/extract \\\n    -H 'Content-Type: multipart/form-data' \\\n    -H \"Authorization: Bearer $VISION_AGENT_API_KEY\" \\\n    -F schema=schema"
      }
    }
  },
  {
    ...
    "response": "{ chunks: { id: string; grounding: { box: parse_grounding_box; page: number; }; markdown: string; type: string; }[]; markdown: string; metadata: { credit_usage: number; duration_ms: number; filename: string; job_id: string; org_id: string; page_count: number; version: string; failed_pages?: number[]; }; splits: { chunks: string[]; class: string; identifier: string; markdown: string; pages: number[]; }[]; grounding?: object; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.va.landing.ai/v1/ade/parse \\\n    -H 'Content-Type: multipart/form-data' \\\n    -H \"Authorization: Bearer $VISION_AGENT_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ metadata: { credit_usage: number; duration_ms: number; filename: string; page_count: number; job_id?: string; org_id?: string; version?: string; }; splits: { classification: string; identifier: string; markdowns: string[]; pages: number[]; }[]; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.va.landing.ai/v1/ade/split \\\n    -H 'Content-Type: multipart/form-data' \\\n    -H \"Authorization: Bearer $VISION_AGENT_API_KEY\" \\\n    -F split_class='[{\"name\":\"name\"}]'"
      }
    }
  },
  {
    ...
    "response": "{ classification: { class: string; page: number; reason?: string; suggested_class?: string; }[]; metadata: { credit_usage: number; duration_ms: number; filename: string; page_count: number; job_id?: string; org_id?: string; version?: string; }; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.va.landing.ai/v1/ade/classify \\\n    -H 'Content-Type: multipart/form-data' \\\n    -H \"Authorization: Bearer $VISION_AGENT_API_KEY\" \\\n    -F classes='[{\"class\":\"class\"}]'"
      }
    }
  },
  {
    ...
    "response": "{ metadata: { credit_usage: number; duration_ms: number; filename: string; job_id?: string; org_id?: string; version?: string; }; table_of_contents: { level: number; section_number: string; start_reference: string; title: string; }[]; table_of_contents_md: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.va.landing.ai/v1/ade/section \\\n    -H 'Content-Type: multipart/form-data' \\\n    -H \"Authorization: Bearer $VISION_AGENT_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.va.landing.ai/v1/ade/extract/build-schema \\\n    -H 'Content-Type: multipart/form-data' \\\n    -H \"Authorization: Bearer $VISION_AGENT_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.va.landing.ai/v1/ade/parse/jobs \\\n    -H 'Content-Type: multipart/form-data' \\\n    -H \"Authorization: Bearer $VISION_AGENT_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ jobs: { job_id: string; progress: number; received_at: number; status: string; failure_reason?: string; }[]; has_more?: boolean; org_id?: string; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.va.landing.ai/v1/ade/parse/jobs/$JOB_ID \\\n    -H \"Authorization: Bearer $VISION_AGENT_API_KEY\""
      }
    }
  }
];
