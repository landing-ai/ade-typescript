...
[Open VS Code](https://vscode.stainless.com/mcp/%7B%22name%22%3A%22landingai-ade-mcp%22%2C%22command%22%3A%22npx%22%2C%22args%22%3A%5B%22-y%22%2C%22landingai-ade-mcp%22%5D%2C%22env%22%3A%7B%22VISION_AGENT_API_KEY%22%3A%22My%20Apikey%22%7D%7D)
...
```
claude mcp add landingai_ade_mcp_api --env VISION_AGENT_API_KEY="My Apikey" -- npx -y landingai-ade-mcp
```
